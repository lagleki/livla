...
function sisku(query, callback) {
	...
	var traji_rimni=[];
	var 10_moi_lo_traji_rimni = [];
	var 20_moi_lo_traji_rimni = [];
	var 30_moi_lo_traji_rimni = [];
	var 40_moi_lo_traji_rimni = [];
	var 60_moi_lo_traji_rimni = [];
	var 50_moi_lo_traji_rimni = [];
	var 70_moi_lo_traji_rimni = [];
	var 80_moi_lo_traji_rimni = [];
	var 90_moi_lo_traji_rimni = [];
	var queryP,queryF;
	Array.prototype.cupra_lo_porsi = function (){
		for (var i=0;i<this.length;i++) {
			...
			if (doc.w.krulermorna() === query){
				10_moi_lo_traji_rimni.push(doc);
				continue;
			}
			else if(queryR 
				...
				20_moi_lo_traji_rimni.push(doc);
			}
			else if(queryR 
					&& (docw[0].match(queryR[0])||[]).length>0
					&& (docw[1].match(queryR[1])||[]).length>0
				...
				30_moi_lo_traji_rimni.push(doc);
			}			
			else if(queryR 
				...
				40_moi_lo_traji_rimni.push(doc);
			}
			else if(queryR 
					&& (docw[1].match(queryR[2].regexify())||[]).length>0
					&& sli
				...
				50_moi_lo_traji_rimni.push(doc);
			}
			else if(queryR 
					&& (docw[0].match(queryR[0])||[]).length>0
					&& sli
				...
				60_moi_lo_traji_rimni.push(doc);
			}
				...
				70_moi_lo_traji_rimni.push(doc);
			}
			else if(queryR 
					&& (docw[0].match(queryR[0])||[]).length>0
					&& (docw[1].match(queryR[1])||[]).length>0
					){
				80_moi_lo_traji_rimni.push(doc);
			}			
			else {
				90_moi_lo_traji_rimni.push(doc);
			}
		}
		...
		//10_moi_lo_traji_rimni=sor(10_moi_lo_traji_rimni);
		20_moi_lo_traji_rimni=sor(20_moi_lo_traji_rimni);
		30_moi_lo_traji_rimni=sor(30_moi_lo_traji_rimni);
		60_moi_lo_traji_rimni=sor(60_moi_lo_traji_rimni);
		40_moi_lo_traji_rimni=sor(40_moi_lo_traji_rimni);
		50_moi_lo_traji_rimni=sor(50_moi_lo_traji_rimni);
		70_moi_lo_traji_rimni=sor(70_moi_lo_traji_rimni);
		80_moi_lo_traji_rimni=sor(80_moi_lo_traji_rimni);
		90_moi_lo_traji_rimni=sor(90_moi_lo_traji_rimni);
		var traji_rimni=
		10_moi_lo_traji_rimni
		.concat(20_moi_lo_traji_rimni)
		.concat(30_moi_lo_traji_rimni)
		.concat(40_moi_lo_traji_rimni)
		.concat(50_moi_lo_traji_rimni)
		.concat(60_moi_lo_traji_rimni)
		.concat(70_moi_lo_traji_rimni)
		.concat(80_moi_lo_traji_rimni)
		.concat(90_moi_lo_traji_rimni);
		return traji_rimni;
	};
