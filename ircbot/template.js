...
//config
var langs = ["en","ru","eo","es","fr-facile","ile","ithkuil","ja","jbo","laadan","ldp","ru","zamenhofo","toki","jb","en-pt-BR","muplis","muplis-eng-pol","test","en-rimni"];
...
langs.forEach(function(thisa){
	...
	try{m = file.match(/titlelogo *= *[\"'](.*?)[\"'];*([\n\r]+|$)/)[1].replace(/\\\"/g,"\"").replace(/%upper%/g,upper);}catch(err){m="<span id='plise' style='display: none;'><a id='st' href=\""+upper+"\"><img src=\"../arrow-left.png\" height='24' width='24'></a></span><span class='site-title' style='margin-left:10px;'><a id='title' href='#'><img src=\"../sutysisku.png\" height='16' width='16'><font color='#fff'>la sutysisku</font></a></span>";}b = b.replace(/%titlelogo%/g,m);
