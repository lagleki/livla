...
var bangu = function (lng, username)
{
  ...
  switch (lng)
  {
    ...
    case 'en':
      ...
      break;
    default:
      ret = 'i ca\'e mi ba tavla do fo no drata be la\'e ' + lng.toUpperCase() + 'doi la\'o zoi.' + username + '.zoi.'; // TODO: translate to lojban
      break;
  }
  updateUserSettings();
  return ret;
