...
{$$ = new_node_5(STATEMENT_3,$1,$2,$3,$4,$5);}
            | tag TUhE free_seq text_1 
{$$ = new_node_5(STATEMENT_3,$1,$2,$3,$4,new_elidable(1454,TUhU));}
...
{$$ = new_node_4(STATEMENT_3,$1,$2,$3,$4);}
            | tag TUhE          text_1 
{$$ = new_node_4(STATEMENT_3,$1,$2,$3,new_elidable(1454,TUhU));}

            |     TUhE free_seq text_1 TUhU free_seq
{$$ = new_node_5(STATEMENT_3,$1,$2,$3,$4,$5);}
            |     TUhE free_seq text_1 TUhU
{$$ = new_node_4(STATEMENT_3,$1,$2,$3,$4);}
            |     TUhE free_seq text_1 
{$$ = new_node_4(STATEMENT_3,$1,$2,$3,new_elidable(1454,TUhU));}
...
{$$ = new_node_3(STATEMENT_3,$1,$2,$3);}
            |     TUhE          text_1 
{$$ = new_node_3(STATEMENT_3,$1,$2,new_elidable(1454,TUhU));}
            ;
...
{$$ = new_node_2(FRAGMENT,$1,$2);}
         | terms 
{$$ = new_node_2(FRAGMENT,$1,new_elidable(1489,VAU));}
         | prenex
{$$ = new_node_1(FRAGMENT,$1);}
         | relative_clauses
{$$ = new_node_1(FRAGMENT,$1);}
...
{$$ = new_node_1(NO_CU_SENTENCE,$1);}
               | terms  bridi_tail
{$$ = new_node_3(NO_CU_SENTENCE,$1,new_elidable(266,CU),$2);}
               ;
...
{$$ = new_node_8(BRIDI_TAIL,$1,$2,$3,$4,$5,$6,$7,$8);}
           | bridi_tail_1 gihek_stag_ke KE free_seq bridi_tail KEhE free_seq 
{$$ = new_node_8(BRIDI_TAIL,$1,$2,$3,$4,$5,$6,$7,new_elidable(1489,VAU));}
           | bridi_tail_1 gihek_stag_ke KE free_seq bridi_tail KEhE          tail_terms
{$$ = new_node_7(BRIDI_TAIL,$1,$2,$3,$4,$5,$6,$7);}
           | bridi_tail_1 gihek_stag_ke KE free_seq bridi_tail KEhE          
{$$ = new_node_7(BRIDI_TAIL,$1,$2,$3,$4,$5,$6,new_elidable(1489,VAU));}
           | bridi_tail_1 gihek_stag_ke KE free_seq bridi_tail  tail_terms
{$$ = new_node_7(BRIDI_TAIL,$1,$2,$3,$4,$5,new_elidable(723,KEhE),$6);}
           | bridi_tail_1 gihek_stag_ke KE free_seq bridi_tail  
{$$ = new_node_7(BRIDI_TAIL,$1,$2,$3,$4,$5,new_elidable(723,KEhE),new_elidable(1489,VAU));}

           | bridi_tail_1 gihek_stag_ke KE          bridi_tail KEhE free_seq tail_terms
{$$ = new_node_7(BRIDI_TAIL,$1,$2,$3,$4,$5,$6,$7);}
           | bridi_tail_1 gihek_stag_ke KE          bridi_tail KEhE free_seq 
{$$ = new_node_7(BRIDI_TAIL,$1,$2,$3,$4,$5,$6,new_elidable(1489,VAU));}
           | bridi_tail_1 gihek_stag_ke KE          bridi_tail KEhE          tail_terms
{$$ = new_node_6(BRIDI_TAIL,$1,$2,$3,$4,$5,$6);}
           | bridi_tail_1 gihek_stag_ke KE          bridi_tail KEhE          
{$$ = new_node_6(BRIDI_TAIL,$1,$2,$3,$4,$5,new_elidable(1489,VAU));}
           | bridi_tail_1 gihek_stag_ke KE          bridi_tail  tail_terms
{$$ = new_node_6(BRIDI_TAIL,$1,$2,$3,$4,new_elidable(723,KEhE),$5);}
           | bridi_tail_1 gihek_stag_ke KE          bridi_tail               
{$$ = new_node_5(BRIDI_TAIL,$1,$2,$3,$4,new_elidable(1489,VAU));}
           ;
...
{$$ = new_node_5(BRIDI_TAIL_1,$1,$2,$3,$4,$5);}
             | bridi_tail_1 gihek free_seq bridi_tail_2 
{$$ = new_node_5(BRIDI_TAIL_1,$1,$2,$3,$4,new_elidable(1489,VAU));}
             | bridi_tail_1 gihek          bridi_tail_2 tail_terms
{$$ = new_node_4(BRIDI_TAIL_1,$1,$2,$3,$4);}
             | bridi_tail_1 gihek          bridi_tail_2 
{$$ = new_node_4(BRIDI_TAIL_1,$1,$2,$3,new_elidable(1489,VAU));}
             ;
...
{$$ = new_node_4(BRIDI_TAIL_2,$1,$2,$3,$4);}
             | bridi_tail_2 gihek_stag_bo bridi_tail_2 
{$$ = new_node_4(BRIDI_TAIL_2,$1,$2,$3,new_elidable(1489,VAU));}
             ;
...
{$$ = new_node_2(BRIDI_TAIL_3,$1,$2);}
             | main_selbri 
{$$ = new_node_2(BRIDI_TAIL_3,$1,new_elidable(1489,VAU));}
             | gek_sentence
...
{$$ = new_node_2(TAIL_TERMS,$1,$2);}
           | terms 
{$$ = new_node_2(TAIL_TERMS,$1,new_elidable(1489,VAU));}
           |       VAU free_seq
{$$ = new_node_2(TAIL_TERMS,$1,$2);}
           |       VAU
...
{$$ = new_node_5(GEK_SENTENCE,$1,$2,$3,$4,new_elidable(1489,VAU));}

             | tag KE free_seq gek_sentence KEhE free_seq
{$$ = new_node_6(GEK_SENTENCE,$1,$2,$3,$4,$5,$6);}
             | tag KE free_seq gek_sentence KEhE
{$$ = new_node_5(GEK_SENTENCE,$1,$2,$3,$4,$5);}
             | tag KE free_seq gek_sentence 
{$$ = new_node_5(GEK_SENTENCE,$1,$2,$3,$4,new_elidable(723,KEhE));}
...
{$$ = new_node_4(GEK_SENTENCE,$1,$2,$3,$4);}
             | tag KE          gek_sentence 
{$$ = new_node_4(GEK_SENTENCE,$1,$2,$3,new_elidable(723,KEhE));}

             |     KE free_seq gek_sentence KEhE free_seq
{$$ = new_node_5(GEK_SENTENCE,$1,$2,$3,$4,$5);}
             |     KE free_seq gek_sentence KEhE
{$$ = new_node_4(GEK_SENTENCE,$1,$2,$3,$4);}
             |     KE free_seq gek_sentence 
{$$ = new_node_4(GEK_SENTENCE,$1,$2,$3,new_elidable(723,KEhE));}
...
{$$ = new_node_3(GEK_SENTENCE,$1,$2,$3);}
             |     KE          gek_sentence 
{$$ = new_node_3(GEK_SENTENCE,$1,$2,new_elidable(723,KEhE));}
...
{$$ = new_node_2(TERM_FLOATING_TENSE,$1,$2);}
                    | tag 
{$$ = new_node_2(TERM_FLOATING_TENSE,$1,new_elidable(756,KU));}
                    ;
...
{$$ = new_node_3(TERM_OTHER,$1,$2,$3);}
           | FA free_seq 
{$$ = new_node_3(TERM_OTHER,$1,$2,new_elidable(756,KU));}
           | FA          KU free_seq
{$$ = new_node_3(TERM_OTHER,$1,$2,$3);}
           | FA          KU 
{$$ = new_node_2(TERM_OTHER,$1,$2);}
           | FA 
{$$ = new_node_2(TERM_OTHER,$1,new_elidable(756,KU));}
           ;
...
{$$ = new_node_2(TERMSET_BODY,$1,$2);}
             | terms 
{$$ = new_node_2(TERMSET_BODY,$1,new_elidable(1062,NUhU));}
             ;
...
{$$ = new_node_4(KE_SUMTI,$1,$2,$3,$4);}
         | KE free_seq sumti 
{$$ = new_node_4(KE_SUMTI,$1,$2,$3,new_elidable(723,KEhE));}
         | KE          sumti KEhE free_seq
{$$ = new_node_4(KE_SUMTI,$1,$2,$3,$4);}
         | KE          sumti KEhE
{$$ = new_node_3(KE_SUMTI,$1,$2,$3);}
         | KE          sumti 
{$$ = new_node_3(KE_SUMTI,$1,$2,new_elidable(723,KEhE));}
         ;
...
{$$ = new_node_3(SUMTI_5B,$1,$2,$3);}
         | quantifier selbri 
{$$ = new_node_3(SUMTI_5B,$1,$2,new_elidable(756,KU));}
         ;
...
{$$ = new_node_3(SUMTI_6,$1,$2,$3);}
        | LE               sumti_tail 
{$$ = new_node_3(SUMTI_6,$1,$2,new_elidable(756,KU));}

        | LA      free_seq sumti_tail KU free_seq
{$$ = new_node_5(SUMTI_6,$1,$2,$3,$4,$5);}
        | LA      free_seq sumti_tail KU
{$$ = new_node_4(SUMTI_6,$1,$2,$3,$4);}
        | LA      free_seq sumti_tail 
{$$ = new_node_4(SUMTI_6,$1,$2,$3,new_elidable(756,KU));}
...
{$$ = new_node_4(SUMTI_6,$1,$2,$3,$4);}
        | LI      free_seq mex 
{$$ = new_node_4(SUMTI_6,$1,$2,$3,new_elidable(851,LOhO));}
...
{$$ = new_node_3(SUMTI_6,$1,$2,$3);}
        | LI               mex 
{$$ = new_node_3(SUMTI_6,$1,$2,new_elidable(851,LOhO));}
...
{$$ = new_node_3(SUMTI_6,$1,$2,$3);}
        | LU text  
{$$ = new_node_3(SUMTI_6,$1,$2,new_elidable(838,LIhU));}
        | LOhU free_seq 
{$$ = new_node_2(SUMTI_6,$1,$2);}
        | LOhU          
{$$ = new_node_1(SUMTI_6,$1);}
...
{$$ = new_node_5(LAHE_SUMTI_6,$1,$2,$3,$4,$5);}
             | LAhE    free_seq relative_clauses sumti 
{$$ = new_node_5(LAHE_SUMTI_6,$1,$2,$3,$4,new_elidable(866,LUhU));}
             | LAhE    free_seq                  sumti LUhU free_seq
{$$ = new_node_5(LAHE_SUMTI_6,$1,$2,$3,$4,$5);}
             | LAhE    free_seq                  sumti LUhU
{$$ = new_node_4(LAHE_SUMTI_6,$1,$2,$3,$4);}
             | LAhE    free_seq                  sumti 
{$$ = new_node_4(LAHE_SUMTI_6,$1,$2,$3,new_elidable(866,LUhU));}

             | LAhE             relative_clauses sumti LUhU free_seq
{$$ = new_node_5(LAHE_SUMTI_6,$1,$2,$3,$4,$5);}
             | LAhE             relative_clauses sumti LUhU
{$$ = new_node_4(LAHE_SUMTI_6,$1,$2,$3,$4);}
             | LAhE             relative_clauses sumti 
{$$ = new_node_4(LAHE_SUMTI_6,$1,$2,$3,new_elidable(866,LUhU));}
...
{$$ = new_node_3(LAHE_SUMTI_6,$1,$2,$3);}
             | LAhE                              sumti 
{$$ = new_node_3(LAHE_SUMTI_6,$1,$2,new_elidable(866,LUhU));}
             ;
...
{$$ = new_node_6(NAHE_BO_SUMTI_6,$2,$3,$4,$5,$6,$7);}
                | PRIVATE_NAhE_BO NAhE BO free_seq relative_clauses sumti 
{$$ = new_node_6(NAHE_BO_SUMTI_6,$2,$3,$4,$5,$6,new_elidable(866,LUhU));}
...
{$$ = new_node_5(NAHE_BO_SUMTI_6,$2,$3,$4,$5,$6);}
                | PRIVATE_NAhE_BO NAhE BO free_seq                  sumti 
{$$ = new_node_5(NAHE_BO_SUMTI_6,$2,$3,$4,$5,new_elidable(866,LUhU));}

                | PRIVATE_NAhE_BO NAhE BO          relative_clauses sumti LUhU free_seq
{$$ = new_node_6(NAHE_BO_SUMTI_6,$2,$3,$4,$5,$6,$7);}
                | PRIVATE_NAhE_BO NAhE BO          relative_clauses sumti LUhU
{$$ = new_node_5(NAHE_BO_SUMTI_6,$2,$3,$4,$5,$6);}
                | PRIVATE_NAhE_BO NAhE BO          relative_clauses sumti 
{$$ = new_node_5(NAHE_BO_SUMTI_6,$2,$3,$4,$5,new_elidable(866,LUhU));}
                | PRIVATE_NAhE_BO NAhE BO                           sumti LUhU free_seq
{$$ = new_node_5(NAHE_BO_SUMTI_6,$2,$3,$4,$5,$6);}
                | PRIVATE_NAhE_BO NAhE BO                           sumti LUhU
{$$ = new_node_4(NAHE_BO_SUMTI_6,$2,$3,$4,$5);}
                | PRIVATE_NAhE_BO NAhE BO                           sumti 
{$$ = new_node_4(NAHE_BO_SUMTI_6,$2,$3,$4,new_elidable(866,LUhU));}
                ;
...
{$$ = new_node_4(TERM_RELATIVE_CLAUSE,$1,$2,$3,$4);}
                     | GOI free_seq term 
{$$ = new_node_4(TERM_RELATIVE_CLAUSE,$1,$2,$3,new_elidable(530,GEhU));}
                     | GOI          term GEhU free_seq
{$$ = new_node_4(TERM_RELATIVE_CLAUSE,$1,$2,$3,$4);}
                     | GOI          term GEhU
{$$ = new_node_3(TERM_RELATIVE_CLAUSE,$1,$2,$3);}
                     | GOI          term 
{$$ = new_node_3(TERM_RELATIVE_CLAUSE,$1,$2,new_elidable(530,GEhU));}
                     ;
...
{$$ = new_node_4(FULL_RELATIVE_CLAUSE,$1,$2,$3,$4);}
                     | NOI free_seq subsentence 
{$$ = new_node_4(FULL_RELATIVE_CLAUSE,$1,$2,$3,new_elidable(767,KUhO));}
                     | NOI          subsentence KUhO free_seq
{$$ = new_node_4(FULL_RELATIVE_CLAUSE,$1,$2,$3,$4);}
                     | NOI          subsentence KUhO
{$$ = new_node_3(FULL_RELATIVE_CLAUSE,$1,$2,$3);}
                     | NOI          subsentence 
{$$ = new_node_3(FULL_RELATIVE_CLAUSE,$1,$2,new_elidable(767,KUhO));}
                     ;
...
{$$ = new_node_4(KE_SELBRI_3,$1,$2,$3,$4);}
            | KE free_seq selbri_3 
{$$ = new_node_4(KE_SELBRI_3,$1,$2,$3,new_elidable(723,KEhE));}
            | KE          selbri_3 KEhE free_seq
{$$ = new_node_4(KE_SELBRI_3,$1,$2,$3,$4);}
            | KE          selbri_3 KEhE
{$$ = new_node_3(KE_SELBRI_3,$1,$2,$3);}
            | KE          selbri_3 
{$$ = new_node_3(KE_SELBRI_3,$1,$2,new_elidable(723,KEhE));}
            ;
...
{$$ = new_node_6(TANRU_UNIT_2,$1,$2,$3,new_elidable(922,MEhU),$4,$5);}
                  | ME free_seq sumti     MOI
{$$ = new_node_5(TANRU_UNIT_2,$1,$2,$3,new_elidable(922,MEhU),$4);}
                  | ME free_seq sumti    
{$$ = new_node_4(TANRU_UNIT_2,$1,$2,$3,new_elidable(922,MEhU));}
...
{$$ = new_node_5(TANRU_UNIT_2,$1,$2,new_elidable(922,MEhU),$3,$4);}
                  | ME          sumti     MOI
{$$ = new_node_4(TANRU_UNIT_2,$1,$2,new_elidable(922,MEhU),$3);}
                  | ME          sumti    
{$$ = new_node_3(TANRU_UNIT_2,$1,$2,new_elidable(922,MEhU));}
...
{$$ = new_node_4(KE_SELBRI3_TU2,$1,$2,$3,$4);}
               | KE free_seq selbri_3 
{$$ = new_node_4(KE_SELBRI3_TU2,$1,$2,$3,new_elidable(723,KEhE));}
               | KE          selbri_3 KEhE free_seq
{$$ = new_node_4(KE_SELBRI3_TU2,$1,$2,$3,$4);}
               | KE          selbri_3 KEhE
{$$ = new_node_3(KE_SELBRI3_TU2,$1,$2,$3);}
               | KE          selbri_3 
{$$ = new_node_3(KE_SELBRI3_TU2,$1,$2,new_elidable(723,KEhE));}
               ;
...
{$$ = new_node_3(ABSTRACTION,$1,$2,$3);}
            | nu_nai_seq subsentence 
{$$ = new_node_3(ABSTRACTION,$1,$2,new_elidable(717,KEI));}
            ;
...
{$$ = new_node_5(LINKARGS,$1,$2,$3,$4,$5);}
         | BE free_seq term links 
{$$ = new_node_5(LINKARGS,$1,$2,$3,$4,new_elidable(137,BEhO));}
         | BE          term links BEhO free_seq
{$$ = new_node_5(LINKARGS,$1,$2,$3,$4,$5);}
         | BE          term links BEhO
{$$ = new_node_4(LINKARGS,$1,$2,$3,$4);}
         | BE          term links 
{$$ = new_node_4(LINKARGS,$1,$2,$3,new_elidable(137,BEhO));}
...
{$$ = new_node_3(LINKARGS,$1,$2,$3);}
         | BE          term       
{$$ = new_node_3(LINKARGS,$1,$2,new_elidable(137,BEhO));}
         ;
...
{$$ = new_node_2(QUANTIFIER,$1,$2);}
           | number 
{$$ = new_node_2(QUANTIFIER,$1,new_elidable(157,BOI));}
           | VEI free_seq mex VEhO free_seq
{$$ = new_node_5(QUANTIFIER,$1,$2,$3,$4,$5);}
           | VEI free_seq mex VEhO
{$$ = new_node_4(QUANTIFIER,$1,$2,$3,$4);}
           | VEI free_seq mex 
{$$ = new_node_4(QUANTIFIER,$1,$2,$3,new_elidable(1509,VEhO));}
           | VEI          mex VEhO free_seq
{$$ = new_node_4(QUANTIFIER,$1,$2,$3,$4);}
           | VEI          mex VEhO
{$$ = new_node_3(QUANTIFIER,$1,$2,$3);}
           | VEI          mex 
{$$ = new_node_3(QUANTIFIER,$1,$2,new_elidable(1509,VEhO));}
           ;
...
{$$ = new_node_5(MEX_2,$1,$2,$3,$4,$5);}
      | PEhO free_seq operator mex_2_seq 
{$$ = new_node_5(MEX_2,$1,$2,$3,$4,new_elidable(765,KUhE));}

      | PEhO          operator mex_2_seq KUhE free_seq
{$$ = new_node_5(MEX_2,$1,$2,$3,$4,$5);}
      | PEhO          operator mex_2_seq KUhE
{$$ = new_node_4(MEX_2,$1,$2,$3,$4);}
      | PEhO          operator mex_2_seq 
{$$ = new_node_4(MEX_2,$1,$2,$3,new_elidable(765,KUhE));}
...
{$$ = new_node_3(MEX_2,$1,$2,$3);}
      |               operator mex_2_seq 
{$$ = new_node_3(MEX_2,$1,$2,new_elidable(765,KUhE));}
      ;
...
{$$ = new_node_4(KE_OPERATOR,$1,$2,$3,$4);}
            | KE free_seq operator 
{$$ = new_node_4(KE_OPERATOR,$1,$2,$3,new_elidable(723,KEhE));}
            | KE          operator KEhE free_seq
{$$ = new_node_4(KE_OPERATOR,$1,$2,$3,$4);}
            | KE          operator KEhE
{$$ = new_node_3(KE_OPERATOR,$1,$2,$3);}
            | KE          operator 
{$$ = new_node_3(KE_OPERATOR,$1,$2,new_elidable(723,KEhE));}
            ;
...
{$$ = new_node_4(OPERATOR_2,$1,$2,$3,$4);}
           | KE free_seq operator 
{$$ = new_node_4(OPERATOR_2,$1,$2,$3,new_elidable(723,KEhE));}
           | KE          operator KEhE free_seq
{$$ = new_node_4(OPERATOR_2,$1,$2,$3,$4);}
           | KE          operator KEhE
{$$ = new_node_3(OPERATOR_2,$1,$2,$3);}
           | KE          operator 
{$$ = new_node_3(OPERATOR_2,$1,$2,new_elidable(723,KEhE));}
           ;
...
{$$ = new_node_4(MEX_OPERATOR,$1,$2,$3,$4);}
             | MAhO free_seq mex 
{$$ = new_node_4(MEX_OPERATOR,$1,$2,$3,new_elidable(1412,TEhU));}
             | MAhO          mex TEhU free_seq
{$$ = new_node_4(MEX_OPERATOR,$1,$2,$3,$4);}
             | MAhO          mex TEhU
{$$ = new_node_3(MEX_OPERATOR,$1,$2,$3);}
             | MAhO          mex 
{$$ = new_node_3(MEX_OPERATOR,$1,$2,new_elidable(1412,TEhU));}
             | NAhU free_seq selbri TEhU free_seq
{$$ = new_node_5(MEX_OPERATOR,$1,$2,$3,$4,$5);}
             | NAhU free_seq selbri TEhU
{$$ = new_node_4(MEX_OPERATOR,$1,$2,$3,$4);}
             | NAhU free_seq selbri 
{$$ = new_node_4(MEX_OPERATOR,$1,$2,$3,new_elidable(1412,TEhU));}
...
{$$ = new_node_4(KE_OPERAND,$1,$2,$3,$4);}
           | KE free_seq operand 
{$$ = new_node_4(KE_OPERAND,$1,$2,$3,new_elidable(723,KEhE));}
           | KE          operand KEhE free_seq
{$$ = new_node_4(KE_OPERAND,$1,$2,$3,$4);}
           | KE          operand KEhE
{$$ = new_node_3(KE_OPERAND,$1,$2,$3);}
           | KE          operand 
{$$ = new_node_3(KE_OPERAND,$1,$2,new_elidable(723,KEhE));}
           ;
...
{$$ = new_node_2(OPERAND_3,$1,$2);}
          | lerfu_string 
{$$ = new_node_2(OPERAND_3,$1,new_elidable(157,BOI));}

          | NIhE free_seq selbri TEhU free_seq
{$$ = new_node_5(OPERAND_3,$1,$2,$3,$4,$5);}
          | NIhE free_seq selbri TEhU
{$$ = new_node_4(OPERAND_3,$1,$2,$3,$4);}
          | NIhE free_seq selbri 
{$$ = new_node_4(OPERAND_3,$1,$2,$3,new_elidable(1412,TEhU));}
          | NIhE          selbri TEhU free_seq
{$$ = new_node_4(OPERAND_3,$1,$2,$3,$4);}
          | NIhE          selbri TEhU
{$$ = new_node_3(OPERAND_3,$1,$2,$3);}
          | NIhE          selbri 
{$$ = new_node_3(OPERAND_3,$1,$2,new_elidable(1412,TEhU));}
...
{$$ = new_node_4(OPERAND_3,$1,$2,$3,$4);}
          | LAhE free_seq operand 
{$$ = new_node_4(OPERAND_3,$1,$2,$3,new_elidable(866,LUhU));}
          | LAhE          operand LUhU free_seq
{$$ = new_node_4(OPERAND_3,$1,$2,$3,$4);}
          | LAhE          operand LUhU
{$$ = new_node_3(OPERAND_3,$1,$2,$3);}
          | LAhE          operand 
{$$ = new_node_3(OPERAND_3,$1,$2,new_elidable(866,LUhU));}
...
{$$ = new_node_5(OPERAND_3,$2,$3,$4,$5,$6);}
          | PRIVATE_NAhE_BO NAhE BO free_seq operand 
{$$ = new_node_5(OPERAND_3,$2,$3,$4,$5,new_elidable(866,LUhU));}
          | PRIVATE_NAhE_BO NAhE BO          operand LUhU free_seq
{$$ = new_node_5(OPERAND_3,$2,$3,$4,$5,$6);}
          | PRIVATE_NAhE_BO NAhE BO          operand LUhU
{$$ = new_node_4(OPERAND_3,$2,$3,$4,$5);}
          | PRIVATE_NAhE_BO NAhE BO          operand 
{$$ = new_node_4(OPERAND_3,$2,$3,$4,new_elidable(866,LUhU));}
          ;
...
{$$ = new_node_4(COMPLEX_TENSE_MODAL,$1,$2,$3,$4);}
                    | FIhO free_seq selbri 
{$$ = new_node_4(COMPLEX_TENSE_MODAL,$1,$2,$3,new_elidable(432,FEhU));}
                    | FIhO          selbri FEhU free_seq
{$$ = new_node_4(COMPLEX_TENSE_MODAL,$1,$2,$3,$4);}
                    | FIhO          selbri FEhU
{$$ = new_node_3(COMPLEX_TENSE_MODAL,$1,$2,$3);}
                    | FIhO          selbri 
{$$ = new_node_3(COMPLEX_TENSE_MODAL,$1,$2,new_elidable(432,FEhU));}
...
{$$ = new_node_7(METALINGUISTIC,$1,$2,$3,$4,$5,$6,$7);}
               | SEI free_seq terms CU free_seq metalinguistic_main_selbri 
{$$ = new_node_7(METALINGUISTIC,$1,$2,$3,$4,$5,$6,new_elidable(1314,SEhU));}
               | SEI free_seq terms CU          metalinguistic_main_selbri SEhU
{$$ = new_node_6(METALINGUISTIC,$1,$2,$3,$4,$5,$6);}
               | SEI free_seq terms CU          metalinguistic_main_selbri 
{$$ = new_node_6(METALINGUISTIC,$1,$2,$3,$4,$5,new_elidable(1314,SEhU));}
               | SEI free_seq terms             metalinguistic_main_selbri SEhU
{$$ = new_node_5(METALINGUISTIC,$1,$2,$3,$4,$5);}
               | SEI free_seq terms             metalinguistic_main_selbri 
{$$ = new_node_5(METALINGUISTIC,$1,$2,$3,$4,new_elidable(1314,SEhU));}
               | SEI free_seq                   metalinguistic_main_selbri SEhU
{$$ = new_node_4(METALINGUISTIC,$1,$2,$3,$4);}
               | SEI free_seq                   metalinguistic_main_selbri 
{$$ = new_node_4(METALINGUISTIC,$1,$2,$3,new_elidable(1314,SEhU));}

               | SEI          terms CU free_seq metalinguistic_main_selbri SEhU
{$$ = new_node_6(METALINGUISTIC,$1,$2,$3,$4,$5,$6);}
               | SEI          terms CU free_seq metalinguistic_main_selbri 
{$$ = new_node_6(METALINGUISTIC,$1,$2,$3,$4,$5,new_elidable(1314,SEhU));}
               | SEI          terms CU          metalinguistic_main_selbri SEhU
{$$ = new_node_5(METALINGUISTIC,$1,$2,$3,$4,$5);}
               | SEI          terms CU          metalinguistic_main_selbri 
{$$ = new_node_5(METALINGUISTIC,$1,$2,$3,$4,new_elidable(1314,SEhU));}
               | SEI          terms             metalinguistic_main_selbri SEhU
{$$ = new_node_4(METALINGUISTIC,$1,$2,$3,$4);}
               | SEI          terms             metalinguistic_main_selbri 
{$$ = new_node_4(METALINGUISTIC,$1,$2,$3,new_elidable(1314,SEhU));}
               | SEI                            metalinguistic_main_selbri SEhU
{$$ = new_node_3(METALINGUISTIC,$1,$2,$3);}
               | SEI                            metalinguistic_main_selbri 
{$$ = new_node_3(METALINGUISTIC,$1,$2,new_elidable(1314,SEhU));}
               ;
...
{$$ = new_node_5(RECIPROCITY,$1,$2,$3,$4,$5);}
            | SOI free_seq sumti sumti 
{$$ = new_node_5(RECIPROCITY,$1,$2,$3,$4,new_elidable(1314,SEhU));}
            | SOI free_seq sumti       SEhU
{$$ = new_node_4(RECIPROCITY,$1,$2,$3,$4);}
            | SOI free_seq sumti 
{$$ = new_node_4(RECIPROCITY,$1,$2,$3,new_elidable(1314,SEhU));}
...
{$$ = new_node_3(RECIPROCITY,$1,$2,$3);}
            | SOI          sumti 
{$$ = new_node_3(RECIPROCITY,$1,$2,new_elidable(1314,SEhU));}
            ;


free_vocative : vocative relative_clauses selbri relative_clauses DOhU
{$$ = new_node_5(FREE_VOCATIVE,$1,$2,$3,$4,$5);}
              | vocative relative_clauses selbri relative_clauses 
{$$ = new_node_5(FREE_VOCATIVE,$1,$2,$3,$4,new_elidable(362,DOhU));}
              | vocative relative_clauses selbri                  DOhU
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,$4);}
              | vocative relative_clauses selbri 
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,new_elidable(362,DOhU));}
              | vocative                  selbri relative_clauses DOhU
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,$4);}
              | vocative                  selbri relative_clauses 
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,new_elidable(362,DOhU));}
              | vocative                  selbri                  DOhU
{$$ = new_node_3(FREE_VOCATIVE,$1,$2,$3);}
              | vocative                  selbri 
{$$ = new_node_3(FREE_VOCATIVE,$1,$2,new_elidable(362,DOhU));}

              | vocative relative_clauses CMENE_seq free_seq relative_clauses DOhU
{$$ = new_node_6(FREE_VOCATIVE,$1,$2,$3,$4,$5,$6);}
              | vocative relative_clauses CMENE_seq free_seq relative_clauses 
{$$ = new_node_6(FREE_VOCATIVE,$1,$2,$3,$4,$5,new_elidable(362,DOhU));}
              | vocative relative_clauses CMENE_seq free_seq                  DOhU
{$$ = new_node_5(FREE_VOCATIVE,$1,$2,$3,$4,$5);}
              | vocative relative_clauses CMENE_seq free_seq 
{$$ = new_node_5(FREE_VOCATIVE,$1,$2,$3,$4,new_elidable(362,DOhU));}

              | vocative                  CMENE_seq free_seq relative_clauses DOhU
{$$ = new_node_5(FREE_VOCATIVE,$1,$2,$3,$4,$5);}
              | vocative                  CMENE_seq free_seq relative_clauses 
{$$ = new_node_5(FREE_VOCATIVE,$1,$2,$3,$4,new_elidable(362,DOhU));}
              | vocative                  CMENE_seq free_seq                  DOhU
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,$4);}
              | vocative                  CMENE_seq free_seq 
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,new_elidable(362,DOhU));}

              | vocative relative_clauses CMENE_seq          relative_clauses DOhU
{$$ = new_node_5(FREE_VOCATIVE,$1,$2,$3,$4,$5);}
              | vocative relative_clauses CMENE_seq          relative_clauses 
{$$ = new_node_5(FREE_VOCATIVE,$1,$2,$3,$4,new_elidable(362,DOhU));}
              | vocative relative_clauses CMENE_seq                           DOhU
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,$4);}
              | vocative relative_clauses CMENE_seq          
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,new_elidable(362,DOhU));}

              | vocative                  CMENE_seq          relative_clauses DOhU
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,$4);}
              | vocative                  CMENE_seq          relative_clauses 
{$$ = new_node_4(FREE_VOCATIVE,$1,$2,$3,new_elidable(362,DOhU));}
...
{$$ = new_node_2(FREE_VOCATIVE,$1,$2);}
              | vocative 
{$$ = new_node_2(FREE_VOCATIVE,$1,new_elidable(362,DOhU));}
              ;
...
{$$ = new_node_3(PARENTHETICAL,$1,$2,$3);}
              | TO text 
{$$ = new_node_3(PARENTHETICAL,$1,$2,new_elidable(1431,TOI));}
              ;

subscript : XI free_seq number       BOI
{$$ = new_node_4(SUBSCRIPT,$1,$2,$3,$4);}
          | XI free_seq number 
{$$ = new_node_4(SUBSCRIPT,$1,$2,$3,new_elidable(157,BOI));}
          | XI          number       BOI
{$$ = new_node_3(SUBSCRIPT,$1,$2,$3);}
          | XI          number 
{$$ = new_node_3(SUBSCRIPT,$1,$2,new_elidable(157,BOI));}
          | XI free_seq lerfu_string BOI
{$$ = new_node_4(SUBSCRIPT,$1,$2,$3,$4);}
          | XI free_seq lerfu_string 
{$$ = new_node_4(SUBSCRIPT,$1,$2,$3,new_elidable(157,BOI));}
          | XI          lerfu_string BOI
{$$ = new_node_3(SUBSCRIPT,$1,$2,$3);}
          | XI          lerfu_string 
...
{$$ = new_node_6(SUBSCRIPT,$1,$2,$3,$4,$5,$6);}
          | XI free_seq VEI free_seq mex 
{$$ = new_node_6(SUBSCRIPT,$1,$2,$3,$4,$5,new_elidable(1509,VEhO));}
          | XI free_seq VEI          mex VEhO
{$$ = new_node_5(SUBSCRIPT,$1,$2,$3,$4,$5);}
          | XI free_seq VEI          mex 
{$$ = new_node_5(SUBSCRIPT,$1,$2,$3,$4,new_elidable(1509,VEhO));}
...
{$$ = new_node_4(SUBSCRIPT,$1,$2,$3,$4);}
          | XI          VEI          mex 
{$$ = new_node_4(SUBSCRIPT,$1,$2,$3,new_elidable(1509,VEhO));}
          ;
