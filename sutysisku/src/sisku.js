var cmaxes=function(){"use strict";function P(e,r,n,t){this.message=e,this.expected=r,this.found=n,this.location=t,this.name="SyntaxError","function"==typeof Error.captureStackTrace&&Error.captureStackTrace(this,P)}function e(){this.constructor=r}var r,n;return r=P,n=Error,e.prototype=n.prototype,r.prototype=new e,P.buildMessage=function(e,r){var n,u={literal:function(e){return'"'+$(e.text)+'"'},class:function(e){for(var r="",n=0;n<e.parts.length;n++)r+=e.parts[n]instanceof Array?a(e.parts[n][0])+"-"+a(e.parts[n][1]):a(e.parts[n]);return"["+(e.inverted?"^":"")+r+"]"},any:function(e){return"any character"},end:function(e){return"end of input"},other:function(e){return e.description}};function t(e){return e.charCodeAt(0).toString(16).toUpperCase()}function $(e){return e.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\0/g,"\\0").replace(/\t/g,"\\t").replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/[\x00-\x0F]/g,function(e){return"\\x0"+t(e)}).replace(/[\x10-\x1F\x7F-\x9F]/g,function(e){return"\\x"+t(e)})}function a(e){return e.replace(/\\/g,"\\\\").replace(/\]/g,"\\]").replace(/\^/g,"\\^").replace(/-/g,"\\-").replace(/\0/g,"\\0").replace(/\t/g,"\\t").replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/[\x00-\x0F]/g,function(e){return"\\x0"+t(e)}).replace(/[\x10-\x1F\x7F-\x9F]/g,function(e){return"\\x"+t(e)})}return"Expected "+function(e){for(var r,n,t=new Array(e.length),$=0;$<e.length;$++)t[$]=(n=e[$],u[n.type](n));if(t.sort(),0<t.length){for(r=$=1;$<t.length;$++)t[$-1]!==t[$]&&(t[r]=t[$],r++);t.length=r}switch(t.length){case 1:return t[0];case 2:return t[0]+" or "+t[1];default:return t.slice(0,-1).join(", ")+", or "+t[t.length-1]}}(e)+" but "+((n=r)?'"'+$(n)+'"':"end of input")+" found."},{SyntaxError:P,parse:function(p,e){e=void 0!==e?e:{};var r,f={},n={text:0},t=0,h=[function e(r){if("string"==typeof r)return r;var n=[];for(var t in r)n.push(e(r[t]));return n},function(e){return e},function(e){return["cmavo",d(e)]},function(e){return["gismu",d(e)]},function(e){return["lujvo",d(e)]},function(e){return["fu'ivla",d(e)]},function(e){return["cmevla",d(e)]},function(e){return[d(e),"-"]},function(e){return[d(e)]},function(e,r){return[d(e),"-",d(r)]},function(e,r){return[d(e),"-",d(r)]},function(e,r){return[d(e),"-",d(r)]},function(e,r){return[d(e),"-",d(r)]},/^[a]/,c(["a"],!1,!1),/^[aeo]/,c(["a","e","o"],!1,!1),/^[aeiou]/,c(["a","e","i","o","u"],!1,!1),/^[i]/,c(["i"],!1,!1),/^[u]/,c(["u"],!1,!1),/^[y]/,c(["y"],!1,!1),/^[i\u0269]/,c(["i","ɩ"],!1,!1),/^[uw]/,c(["u","w"],!1,!1),function(){return["u",""]},/^[l]/,c(["l"],!1,!1),/^[m]/,c(["m"],!1,!1),/^[n]/,c(["n"],!1,!1),/^[r]/,c(["r"],!1,!1),/^[pfbgvkx]/,c(["p","f","b","g","v","k","x"],!1,!1),/^[d]/,c(["d"],!1,!1),/^[jz]/,c(["j","z"],!1,!1),/^[cs]/,c(["c","s"],!1,!1),/^[x]/,c(["x"],!1,!1),/^[t]/,c(["t"],!1,!1),/^[,']/,c([",","'"],!1,!1),/^[}]/,c(["}"],!1,!1),{type:"any"},/^[^a-za-z,']/,c([["a","z"],["a","z"],",","'"],!0,!1),function(e){return["drata",d(e)]},/^[^ ]/,c([" "],!0,!1)],g=[l("%$;!0#*;!&/' 8!: !! )"),l("%;\"/' 8!:!!! )"),l(";_.î &;#.è &%;'/' 8!:\"!! ).Ö &%;$/' 8!:#!! ).Ä &%%%<;$=.##&&!&'#/#%<;&=
ĵ &%;O.ú &%%;Y/8#%<;Z=.##&&!&'#/#$+\")(\"'#&'#.N &%;X/D#%<;T.) &;R.# &;U=.##&&!&'#/#$+\")(\"'#&'#.\" &\"/#;V.s &%;[.H &;W.B &%;T/8#%<;U=.##&&!&'#/#$+\")(\"'#&'#/8#%<;R=.##&&!&'#/#$+\")(\"'#&'#.# &;S.\" &\"/7$;R.# &;U.\" &\"/#$+#)(#'#(\"'#&'#/M#%<;P=.##&&!&'#/8$%<;F=.##&&!&'#/#$+#)(#'#(\"'#&'#"),l(";H.H &;G.B &%;K/8#%<;E=.##&&!&'#/#$+\")(\"'#&'#"),l("%;L.# &;M/8#%<;E=/##&'!&&#/#$+\")(\"'#&'#"),l("%%4-\"\"5!7./A#;M/8$%<;J=.##&&!&'#/#$+#)(#'#(\"'#&'#.Q &%4/\"\"5!70/A#;L/8$%<;I=.##&&!&'#/#$+#)(#'#(\"'#&'#/8#%<;E=.##&&!&'#/#$+\")(\"'#&'#"),l('%41""5!72/8#%<;E=.##&&!&\'#/#$+")("\'#&\'#'),l('43""5!74'),l('45""5!76'),l("%47\"\"5!78/W#%<%%<;K=.##&&!&'#/,#;E/#$+\")(\"'#&'#=.##&&!&'#/#$+\")(\"'#&'#"),l('49""5!7:'),l('%4;""5!7</& 8!:=! )'),l("%%<;D=/##&'!&&#/J#;P/A$;P/8$%<;P=.##&&!&'#/#$+$)($'#(#'#(\"'#&'#"),l("%;[/,#;Y/#$+\")(\"'#&'#.6 &%;W/,#;X/#$+\")(\"'#&'#"),l(";V.; &;W.5 &;X./ &;Y.) &;[.# &;Q"),l(";R./ &;S.) &;T.# &;U"),l('4>""5!7?'),l('4@""5!7A'),l('%4B""5!7C/8#%<;O=.##&&!&\'#/#$+")("\'#&\'#'),l('4D""5!7E'),l('4F""5!7G'),l('4H""5!7I'),l('4J""5!7K'),l('4L""5!7M'),l('4N""5!7O'),l('4P""5!7Q'),l('%4R""5!7S/8#%<;E=/##&\'!&&#/#$+")("\'#&\'#'),l(';^.N &%%<;E=.##&&!&\'#/,#;"/#$+")("\'#&\'#.) &4T""5!7U'),l(';_.4 &%<1""5!7V=.##&&!&\'#'),l('%$4W""5!7X/,#0)*4W""5!7X&&&#/\' 8!:Y!! )'),l('$4Z""5!7[/,#0)*4Z""5!7[&&&#')],b=0,$=[{line:1,column:1}],u=0,a=[],k=0,x={};if("startRule"in e){if(!(e.startRule in n))throw new Error("Can't start parsing from rule \""+e.startRule+'".');t=n[e.startRule]}function c(e,r,n){return{type:"class",parts:e,inverted:r,ignoreCase:n}}function s(e){var r,n=$[e];if(n)return n;for(r=e-1;!$[r];)r--;for(n={line:(n=$[r]).line,column:n.column};r<e;)10===p.charCodeAt(r)?(n.line++,n.column=1):n.column++,r++;return $[e]=n}function o(e,r){var n=s(e),t=s(r);return{start:{offset:e,line:n.line,column:n.column},end:{offset:r,line:t.line,column:t.column}}}function E(e){b<u||(u<b&&(u=b,a=[]),a.push(e))}function i(e,r,n){return new P(P.buildMessage(e,r),e,r,n)}function l(e){for(var r=new Array(e.length),n=0;n<e.length;n++)r[n]=e.charCodeAt(n)-32;return r}function d(e){if("string"==typeof e)return e;var r="";for(var n in e)r+=d(e[n]);return r}if((r=function e(r){var n,t,$=g[r],u=0,a=[],c=$.length,s=[],o=[],i=65*b+r,l=x[i];if(l)return b=l.nextPos,l.result;for(;;){for(;u<c;)switch($[u]){case 0:o.push(h[$[u+1]]),u+=2;break;case 1:o.push(void 0),u++;break;case 2:o.push(null),u++;break;case 3:o.push(f),u++;break;case 4:o.push([]),u++;break;case 5:o.push(b),u++;break;case 6:o.pop(),u++;break;case 7:b=o.pop(),u++;break;case 8:o.length-=$[u+1],u+=2;break;case 9:o.splice(-2,1),u++;break;case 10:o[o.length-2].push(o.pop()),u++;break;case 11:o.push(o.splice(o.length-$[u+1],$[u+1])),u+=2;break;case 12:o.push(p.substring(o.pop(),b)),u++;break;case 13:s.push(c),a.push(u+3+$[u+1]+$[u+2]),o[o.length-1]?(c=u+3+$[u+1],u+=3):(c=u+3+$[u+1]+$[u+2],u+=3+$[u+1]);break;case 14:s.push(c),a.push(u+3+$[u+1]+$[u+2]),o[o.length-1]===f?(c=u+3+$[u+1],u+=3):(c=u+3+$[u+1]+$[u+2],u+=3+$[u+1]);break;case 15:s.push(c),a.push(u+3+$[u+1]+$[u+2]),o[o.length-1]!==f?(c=u+3+$[u+1],u+=3):(c=u+3+$[u+1]+$[u+2],u+=3+$[u+1]);break;case 16:o[o.length-1]!==f?(s.push(c),a.push(u),c=u+2+$[u+1],u+=2):u+=2+$[u+1];break;case 17:s.push(c),a.push(u+3+$[u+1]+$[u+2]),p.length>b?(c=u+3+$[u+1],u+=3):(c=u+3+$[u+1]+$[u+2],u+=3+$[u+1]);break;case 18:s.push(c),a.push(u+4+$[u+2]+$[u+3]),p.substr(b,h[$[u+1]].length)===h[$[u+1]]?(c=u+4+$[u+2],u+=4):(c=u+4+$[u+2]+$[u+3],u+=4+$[u+2]);break;case 19:s.push(c),a.push(u+4+$[u+2]+$[u+3]),p.substr(b,h[$[u+1]].length).toLowerCase()===h[$[u+1]]?(c=u+4+$[u+2],u+=4):(c=u+4+$[u+2]+$[u+3],u+=4+$[u+2]);break;case 20:s.push(c),a.push(u+4+$[u+2]+$[u+3]),h[$[u+1]].test(p.charAt(b))?(c=u+4+$[u+2],u+=4):(c=u+4+$[u+2]+$[u+3],u+=4+$[u+2]);break;case 21:o.push(p.substr(b,$[u+1])),b+=$[u+1],u+=2;break;case 22:o.push(h[$[u+1]]),b+=h[$[u+1]].length,u+=2;break;case 23:o.push(f),0===k&&E(h[$[u+1]]),u+=2;break;case 24:o[o.length-1-$[u+1]],u+=2;break;case 25:u++;break;case 26:for(n=$.slice(u+4,u+4+$[u+3]),t=0;t<$[u+3];t++)n[t]=o[o.length-1-n[t]];o.splice(o.length-$[u+2],$[u+2],h[$[u+1]].apply(null,n)),u+=4+$[u+3];break;case 27:o.push(e($[u+1])),u+=2;break;case 28:k++,u++;break;case 29:k--,u++;break;default:throw new Error("Invalid opcode: "+$[u]+".")}if(!(0<s.length))break;c=s.pop(),u=a.pop()}return x[i]={nextPos:b,result:o[0]},o[0]}(t))!==f&&b===p.length)return r;throw r!==f&&b<p.length&&E({type:"end"}),i(a,u<p.length?p.charAt(u):null,u<p.length?o(u,u+1):o(u,u))}}}();
...
function sisku(data, callback) {
  ...
  function sortthem(mapti_vreji, multi) {
    ...
    var firstMatches = secupra_vreji.concat(ui[0], ui[1])
    var secondMatches = ui[5].concat(
      ui[2],
      ui[3],
      ui[9],
      ui[4],
